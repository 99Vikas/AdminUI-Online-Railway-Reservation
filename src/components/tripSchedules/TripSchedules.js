...
function TripSchedules() {
  ...
  const loadTripSchedules = async () => {
    try {
      const tripSchedules = await axios.get("http://localhost:8084/train/schedules/getAll", {
        mode: "no-cors",
        headers: {
  ...
  const updateTripSchedule = async (tripSchedule) => {
    ...
    const updatedTripSchedule = axios.put("http://localhost:8084/train/schedules/update/"+tripScheduleForEdit.id,tripSchedule,{
      mode: "no-cors",
      headers: {
        "Access-Control-Allow-Origin": "*",
        "Content-Type": "application/json",
  ...
  const addTripSchedule = (trip) => {
    ...
    const newTripSchedule = axios.post("http://localhost:8084/train/schedules/add",trip,{
      mode: "no-cors",
      headers: {
        "Access-Control-Allow-Origin": "*",
        "Content-Type": "application/json",
  ...
  const deleteTripSchedule = (tripSchedule) => {
    ...
    const deletedTripSchedule = axios.delete("http://localhost:8084/train/schedules/delete/"+tripSchedule.id,{
      mode: "no-cors",
      headers: {
        "Access-Control-Allow-Origin": "*",
        "Content-Type": "application/json",
    ...
    console.log(deletedTripSchedule.data);
  }
